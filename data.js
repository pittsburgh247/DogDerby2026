...
const SITE_DATA = {
  ...
  vendors: [
    ...
    },
    {
      ...
      description: "Boutique bakery selling custom decorated sugar cookies and sweet treats, plus cookie decorating classes.",
    ...
    },
    {
      ...
      description: "Mobile lemonade vendor with a sports theme, serving fresh lemonade and specialty flavors.",
    ...
    },
    {
      ...
      description: "Food truck serving homestyle entrees — Italian roast beef, meatballs, sausage & peppers, mac and cheese, pulled pork, tacos — with gluten-free and vegan options.",
    ...
    },
    {
      ...
      description: "Mobile bartending service operating out of a converted 1976 horse trailer bar.",
    ...
    },
    {
      ...
      description: "Small-batch, family-run hot sauce maker based in Pittsburgh.",
    ...
    },
    {
      ...
      description: "Family-owned Italian bakery and café in Irwin, PA, selling homemade biscotti, coffee, and pastries.",
    ...
    },
    {
      ...
      description: "Mobile hot dog cart serving all-beef hot dogs, turkey/pork sausages, and vegan options with a full range of toppings.",
    ...
    },
    {
      ...
      description: "Mobile dog treat bakery based in Oakmont, PA, selling unique dog treats and hosting dog-focused events.",
...

    {
      ...
      description: "Mobile mini-golf company providing 9 handcrafted, customizable golf holes for events across Western PA.",
    ...
    { name: "Fumo Cigar Bar", category: "Activity" },
    {
      ...
      category: "Food & Drink",
      description: "Dog treat bakery in North Huntingdon, PA, making human-grade, homemade dog treats and supporting animal rescues.",
